      ...
      {step === 'form' ? (
        ...
        <form onSubmit={handleConfirm} className="space-y-5">
          <p className="text-sm text-slate-300">
            Enter the verification code sent to <span className="text-blue-400 font-medium">{email}</span>
          </p>
          ...
          <div>
            ...
            <input
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 bg-slate-900 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all disabled:opacity-50 text-center tracking-widest text-lg"
              placeholder="000000"
              maxLength={6}
            />
          </div>
