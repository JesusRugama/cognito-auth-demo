        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Cognito Scopes Demo</h1>
                <p className="text-xs text-slate-400">Scope-based Authorization</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        <section className="bg-slate-800 border border-slate-700 rounded-xl p-8 shadow-xl">
          <h2 className="text-3xl font-bold text-white mb-3">
            Welcome to the Scope Protection Demo
          </h2>
          <p className="text-slate-300 leading-relaxed max-w-3xl">
            This demo shows how different Cognito app clients grant different OAuth scopes to
            the same user. Log in as <span className="font-semibold text-blue-400">Viewer</span>{' '}
            or <span className="font-semibold text-blue-400">Admin</span> to see which endpoints
            are allowed based on your scopes.
          </p>
        </section>
        ...
        <section className="bg-slate-800 border border-slate-700 rounded-xl p-8 shadow-xl">
          ...
          <div className="border-t border-slate-700 pt-6 mt-6">
            <h4 className="text-sm font-semibold text-slate-300 mb-4">
              Switch Role (Simulates Different App Clients):
            </h4>
            <div className="flex flex-wrap gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-sm">Login as Viewer</div>
